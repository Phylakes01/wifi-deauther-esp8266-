...
// Override the default intro text shown on the OLED display.
// Set this to the text you want to appear after "ESP8266 DEAUTHER BY" on boot.
#ifndef DISPLAY_TEXT
  #define DISPLAY_TEXT "Jeremiah Temporado"
